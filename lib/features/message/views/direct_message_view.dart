...
class _DirectMessageViewState extends State<DirectMessageView> {
  ...
  void _handleSend() {
    if (_messageController.text.isNotEmpty) {
      widget.viewModel.sendMessage(widget.conversationId, _messageController.text);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(widget.chatName, style: const TextStyle(color: Colors.white, fontSize: 16)),
        leading: IconButton(
